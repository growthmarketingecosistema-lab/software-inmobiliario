...
export const CalendarioMixtoView = () => {
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-fade-in">
      <div className="flex justify-between items-start">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-800 tracking-tight">Calendario Mixto Editorial</h1>
            <p className="text-xs text-slate-500 font-bold uppercase tracking-widest mt-0.5">CONTROL CENTRALIZADO: ORGÁNICO, COMERCIAL Y CAMPAÑAS</p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="p-20 flex flex-col items-center justify-center text-center bg-white">
          <p className="text-xs font-medium text-slate-400 font-mono tracking-wider">El calendario mixto está vacío. Agenda el primer contenido.</p>
        </div>
      </div>
    </div>
  );
